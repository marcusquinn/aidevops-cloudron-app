...
main() {
	jq -e '.manifestVersion == 2 and .version == "0.1.6" and .upstreamVersion == "3.32.186" and .minBoxVersion == "9.1.0" and .iconUrl != "" and .packagerName != "" and .packagerUrl == "https://github.com/marcusquinn" and (has("packageUrl") | not) and (.mediaLinks | length) > 0 and .changelog == "file://CHANGELOG"' \
